                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="sectionChooser">
												   ...
												   <form method="POST" action="{{ route('user.register') }}" >
                                                    @csrf
													<div class="form-group">
														<label>Firstname &amp; Lastname</label> <input class="form-control" placeholder="Enter your firstname and lastname" type="text" name='name' >
													</div>
													<div class="form-group">
												...
												<div class="main-signup-footer mt-5">
												   ...
												   <form method="POST" action="{{ route('doctor.register') }}" >
													...
													<div class="form-group">
														<label>Phone</label> <input class="form-control" placeholder="Enter your phone"type="text" name="phone" :value="old('phone')" required autofocus>
													</div>
													<div class="form-group">
														<label>price</label> <input class="form-control" placeholder="Enter your price"type="text" name="price" :value="old('price')" required autofocus>
													</div>

													<div class="form-group">
														<label>oppointment</label> <input class="form-control" placeholder="Enter your oppointmen"type="string" name="oppointment" :value="old('oppointment')" required autofocus>
													</div>
