...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> Doctors</h4><span
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    ...
                                    <img style="border-radius:50%" width="150px" height="150px" id="output" src="Url::asset('Storage/'.$doctor->image->image_name)}}"/ >
                                </div>
                            </div>
                            ...
                            <button type="submit"
                                    class="btn btn-main-primary pd-x-30 mg-r-5 mg-t-5">update</button>
                        </div>
                    </form>
                </div>
            </div>
