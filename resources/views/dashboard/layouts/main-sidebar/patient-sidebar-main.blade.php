			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            <li><a class="slide-item" href="{{route('invoices22.patient')}}">قائمة الفواتير</a></li>
                            <li><a class="slide-item" href="{{route('laboratories.patient')}}">المختبر</a></li>
                            <li><a class="slide-item" href="{{route('rays22.patient')}}">الاشعة</a></li>
						</ul>
					</li>
				</ul>
			</div>
